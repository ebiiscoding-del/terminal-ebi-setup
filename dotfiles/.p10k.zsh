# Generated by Powerlevel10k configuration wizard on 2024-11-30 at 11:32 IST.
...
# 2 lines, dotted, full frame, compact, fluent, instant_prompt=verbose.
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=212
  ...
  typeset -g POWERLEVEL9K_VCS_CLEAN_BACKGROUND=238        # green when clean
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_FOREGROUND=232
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_BACKGROUND=214   # yellow when untracked
